# Contributing to mailtrap-client

## Code Contributions

#### Step 1: Clone

Clone the project on [GitHub](https://github.com/narekhovhannisyan/mailtrap-client.git)
   
   ```bash
   $ git clone https://github.com/narekhovhannisyan/mailtrap-client.git
   $ cd mailtrap-client
   ```
